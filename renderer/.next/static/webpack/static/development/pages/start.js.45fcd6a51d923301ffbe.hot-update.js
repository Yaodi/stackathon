  ...
  _createClass(root, [{
    ...
    value: function grabScores() {
      if (this.state.data) {
        ...
        return lineScore.rowSet.map(function (el) {
          return el.map(function (lol) {
            return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("h1", null, lol);
          });
        });
      }
    }
...
//# sourceMappingURL=start.js.45fcd6a51d923301ffbe.hot-update.js.map