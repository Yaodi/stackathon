  ...
  _createClass(root, [{
    ...
    value: function grabScores() {
      if (this.state.data) {
        ...
        console.log('count', lineScore); //    for (let i = 0; i < lineScore.rowSet.length; i++) {
        //     console.log('for loop');

        return lineScore.headers.map(function (header, idx) {
...
//# sourceMappingURL=start.js.21be7a1aa8151116313c.hot-update.js.map