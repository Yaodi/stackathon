...
function (_Component) {
  ...
  _createClass(root, [{
    ...
    value: function grabScores() {
      var lineScore = this.state.data.resultSets.filter(function (thing) {
        return thing.name === 'LineScore';
      });
      return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("h1", null, Object.keys(lineScore));
    }
  }, {
    key: "render",
...
//# sourceMappingURL=start.js.4037d8d0772e963808cf.hot-update.js.map